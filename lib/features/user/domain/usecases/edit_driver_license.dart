...
class EditDriverLicense extends UseCases<LicenseInfo, Map<String, dynamic>> {
  final UserRepository repository;

  EditDriverLicense({required this.repository});

  @override
  Future<Either<String, LicenseInfo>> call(Map<String, dynamic> params) async {
    return await repository.editDriverLicense(params);
  }
}
