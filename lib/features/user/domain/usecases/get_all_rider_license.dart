...
class GetAllRidersLicense extends UseCases<LicenseInfo, Map<String, dynamic>> {
  final UserRepository repository;

  GetAllRidersLicense({required this.repository});

  @override
  Future<Either<String, LicenseInfo>> call(Map<String, dynamic> params) async {
    return await repository.getAllLicense(params);
  }
}
